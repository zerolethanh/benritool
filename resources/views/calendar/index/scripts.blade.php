<script>
    ...
    function showScheduleForm(data) {
        var _form = id('scheduleform');
        if (!data) { // + button action
            _form.reset();
            setScheduleFormDate(event.target.dataset.date);
    ...
    function setScheduleFormDate(selected_date) {
        //set date field
...
//            trigger: 'hover',
    ...
    $('#newScheduleModal').on('shown.bs.modal', function () {
        id('schedule').focus();
    })
